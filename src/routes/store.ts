import type { countryTypeLocal } from '$lib/scripts/countryType';
 ...
 **/
export const countriesData: Writable<countryTypeLocal[]> = localWritable('storedCountries', []);
...
export const currentSearchArray: Writable<countryTypeLocal[]> = writable([]);
export const scrollPosition: Writable<number> = writable(0);
export const searchInputString: Writable<string> = writable('');
export const regionSearchArray: Writable<countryTypeLocal[]> = writable([]);
