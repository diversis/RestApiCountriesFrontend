...
>
	<button type="submit"
		...
		>
			{#if focusSearch}
				<path
					class="inline-block stroke-light-mode-very-dark-blue dark:stroke-any-white stroke-[1.5] opacity:0 hover:opacity-100 focus:opacity-100 transition-opacity duration-1000"
